...
public class ConsoleApp {
    ...
    private void adminMenu(User user) {
        while (true) {
            ...
            switch (c) {
                ...
                case "3" -> addMerch();
                case "4" -> {
                    merch.list().forEach(System.out::println);
    ...
    private void trainerMenu(User user) {
        while (true) {
            ...
            String c = in.nextLine();
            switch (c) {
                case "1" -> addWorkoutClass(user.getId());
                case "2" -> workoutClasses.findByTrainer(user.getId()).forEach(System.out::println);
                case "3" -> buyMembership(user.getId());
    ...
    private void memberMenu(User user) {
        while (true) {
            ...
            String c = in.nextLine();
            switch (c) {
                case "1" -> workoutClasses.findAll().forEach(System.out::println);
    ...
    private void addMerch() {
        ...
        var price = new BigDecimal(in.nextLine());
    ...
    private void addWorkoutClass(int trainerId) {
        System.out.print("Class type: ");
        String type = in.nextLine();
        System.out.print("Description: ");
        String desc = in.nextLine();

        var c = new WorkoutClass(0, type, desc, trainerId);
        var added = workoutClasses.addClass(c); // <- use service method
